  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-[calc(100vh-120px)] px-4">
      <motion.div
        ...
        className="w-full max-w-md backdrop-blur-xl bg-slate-900/80 border border-slate-800 rounded-3xl p-8 shadow-2xl"
      >
        <div className="text-center mb-8">
          ...
          <p className="text-xs text-slate-400 mt-1">Sign in to your Candidate Coach account</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          >
            {loading ? "Authenticating..." : "Sign In to Candidate Dashboard"} <ArrowRight className="w-4 h-4" />
          </button>
        </form>
